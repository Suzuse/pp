...
@section('content')
    <div id="breadcrumb"> <a href="{{route('admin_home')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('verifyemail')}}" class="current">Farmer Verification</a></div>
