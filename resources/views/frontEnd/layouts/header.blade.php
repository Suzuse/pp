                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +977-9807400588</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> farmingassist@farm.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="logo pull-left">
                        <a href="{{route('welcome')}}"><img src="{{@asset('frontEnd/images/home/logo.png')}}" alt="" width="100" height="100" /></a>
                    </div>
                ...
                <div class="col-sm-9">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="{{route('cart-view')}}" class="{{$menu_active==6? ' active':''}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            @if(Auth::check())
                                ...
                                <li><a href="{{url('/feedback_lists')}}" class="{{$menu_active==12? ' active':''}}"><i class="fa fa-comment"></i> View Reply</a></li>
                                <li><a href="{{url('/index_reply')}}" class="{{$menu_active==13? ' active':''}}"><i class="fa fa-comment"></i> Reply Feedbacks</a></li>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="{{route('welcome')}}" class="{{$menu_active==1? ' active':''}}">Home</a></li>
