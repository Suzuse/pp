...
Route::get('/viewcart','CartController@index')->name('cart-view');
...
Route::group(['middleware'=>'FrontLogin_middleware'],function (){
    ...
    Route::get('/feedback', 'UsersController@feedbackpage')->name('supplierfeedbackpage');
    Route::post('/addfeedbacks','UsersController@addfeedbacks')->name('supplieraddfeedbacks');
    Route::get('/feedback_lists', 'UsersController@Listfeedback');
    Route::get('/reply_index', 'UsersController@replyindex');
...
Route::group(['middleware'=>['auth','isAdmin']],function (){
    ...
    /// Setting Area
    Route::get('/settings', 'AdminController@settings')->name('setting');
    Route::get('/check-pwd','AdminController@chkPassword');
    Route::post('/update-pwd','AdminController@updatAdminPwd');
    Route::get('/verify', 'AdminController@verify')->name('verifyemail');
    Route::get('/updateverification/{id}','AdminController@updateverification')->name('update');
